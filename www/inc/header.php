		...
		?>
				...
				<div id="shortcut">
					<ul>
						...
						<li>
							<a href="javascript:void(0);" id="option4" class="jarvismetro-tile big-cubes bg-color-greenLight"><span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>Change password </span> </span> </a>
						</li>
						<li>
