...
<script>
  var $timezone =   $("#timeZoneSelect");
  var $time = $("#myTime")


  $.ajax({
    url: '/data/timeconfig.json',
    type: 'GET',
    dataType: 'json',
    success: function (data) {
       $("#timeZoneSelect").val(data.timezone).change();
...
//    console.log($timezone.val());
    ...
    $.ajax({
        url: 'ajax/save_time.php',
        type: 'POST',
 	      dataType: 'json',
    	   data: {timedata: JSON.stringify(timeData)},
        success: function (data) {
